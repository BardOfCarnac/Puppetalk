// Translation-owned stability and recovery runtime.
// This is the active behaviour formerly supplied by root stability.js.
(()=>{
  ...
  function recoveryLayout(engine,parts,state){
    ...
    return {
      torso:[x,y,0],head:[x,y-65,0],uaL:[x-37,y-17,.12],faL:[x-42,y+30,.05],
      uaR:[x+37,y-17,-.12],faR:[x+42,y+30,-.05],thL:[x-14,y+65,.04],
      shL:[x-14,y+118,.02],thR:[x+14,y+65,-.04],shR:[x+14,y+118,-.02]
    };
  }
  ...
  window.PuppetalkStability = {version:23,owner:'translation'};
})();
