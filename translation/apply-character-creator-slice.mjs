...
const throwBinding="assert.match(actual,/const controllerThrowGesture = window\\.PuppetalkControllerThrowGesture/,'Runtime is not bound to extracted controller throw gesture.');\n";
