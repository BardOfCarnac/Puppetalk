...
assert.deepEqual(JSON.parse(JSON.stringify(input.grabs)),[{part:'head',x:.5,y:.2}]);
...
console.log('Direct puppet interaction candidate preserves V1 nine-point grab geometry, handle rendering, personal-scene ordering, coordinate clamps, two-pointer limit and pointer grab/move/release lifecycle.');
