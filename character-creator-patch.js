...
// Loaded before boot.js: decorates app.js without touching the tuned physics code.
(() => {
...
`;
  ...
  function patch(source){
    ...
    // Keep the original input declaration intact so boot.js can still install the two-finger controller.
    source=source.replace(
...
`;
  ...
  ctx.fillStyle=look.color;headPath();ctx.fill();
